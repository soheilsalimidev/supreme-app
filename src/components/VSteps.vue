<template>
  <div class="flex flex-col items-center">
    <nav aria-label="Progress" class="w-full" style="direction: rtl">
      <TransitionGroup
        tag="ol"
        role="list"
        class="flex items-center justify-around w-full px-14 flex-row-reverse"
        appear
      ...
      >
        ...
        >
          <div
            v-if="stepIdx !== 4"
            class="w-full bg-gray-200 h-0.5 dark:bg-gray-700 transition"
            :class="step.status === 'complete' && 'dark:!bg-indigo-500/90'"
          ></div>
    ...
    <CustomScrollbar
      class="w-full p-4 overflow-y-scroll h-80 2xl:h-[36rem]"
      content-class="h-full w-full relative "
